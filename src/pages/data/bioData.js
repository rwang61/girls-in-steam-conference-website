...
export const bioData = [
  ...
  },
  {
    ...
    quote:
      'I hope to develop educational resources and events that will empower young women and provide them with the tools they need to explore STEAM fields and careers.'
  },
  {
    name: 'Ariel',
    src: ariel,
  ...
  },
  {
    ...
    quote:
      'As someone who found technology really intimidating, I hope to create a more warm and welcoming community for others who wish to venture into technology!'
  },
  {
    name: 'Claire',
    src: claire,
    ...
    quote:
      'I believe that information is critical for decision-making. By providing more relative information and female role models from similar social, economic, and ethnic backgrounds, I hope that more and more girls will be more motivated and confident to pursue a career in the STEAM domain.”'
  },
  {
    name: 'Coco',
    src: coco,
  ...
  },
  {
    ...
    quote:
      'Being a woman in STEM with an arts background made me realize how much work there is ahead of us. I hope to grow a platform that paves the way for girls who strive to thrive in STEAM fields.'
  },
  {
    name: 'Haley',
    src: haley,
    ...
    quote:
      "I recognize from my past experiences that I'm drawn to organizations and communities whose values align with mine. I am thankful to be a part of Girls in STEAM's advocacy for inclusiveness in the tech industry."
  },
  {
    name: 'Haruka',
    src: haruka,
    ...
    quote:
      'Starting from a young age, I hope to encourage more women to explore STEAM by sharing my personal experiences and providing people with educational tools to help create a foundation of knowledge that they can use in the future.'
  },
  {
    name: 'Julia',
    src: julia,
    ...
    quote:
      'I would wish to facilitate and to encourage other women of similar interests to pursue their strengths and passions, whatever obstacles they might face along the way.'
  },
  {
    name: 'Kristy',
    src: kristy,
  ...
  },
  {
    ...
    quote:
      'As a girl in STEAM, I hope to share my knowledge in arts and technology with others to provide an inclusive community that fosters learning and growth for those interested in the STEAM field.'
  },
  {
    name: 'Melanie',
    src: melanie,
  ...
  },
  {
    ...
    quote:
      'Being someone who was uncertain about their career path and reached out to others for advice, I aspire to motivate more women to jump into the unknown, discover their passions, and gain a deeper understanding of themselves.'
  }
];
