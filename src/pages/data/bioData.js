...
export const bioData = [
    ...
    },
    {
        ...
        emojis: "🏌🏽‍♀️🏊🏼‍♀️🎿🏝️✈️",
        desc: "Born and raised in Tokyo, Japan, Haruka was continually exposed to diverse cultures and perspectives throughout her time attending international schools. Sparked by her curiosity to gain independence and new experiences, she moved to Canada in 2015 to complete her BA and BEd at the University of British Columbia. During her time at university, she took on various roles in student organizations that led her to realize her passion for leadership and community building. Haruka currently works at an all-girls school as an educator, where she inspires her students on a daily basis. In her free time, Haruka enjoys taking part in various athletic activities, such as golf, tennis, swimming, and skiing. She also loves to travel, especially to places with beautiful blue oceans.",
    ...
    },
    {
        ...
        location: LOCATION_STRINGS.VANCOUVER,
        emojis: "🐷😊🙉🍵",
        desc: "Rachel, a University of British Columbia student in her second year of studying Business and Computer Science, is passionate about both finance and technology. She is currently employed as a finance assistant for the UBC Faculty of Dentistry and has experience in data analysis with a Vancouver-based startup called Sonical.ly. Due to the lack of computer science education opportunities in her high school, Rachel is committed to helping students discover the diverse range of fields available in the tech industry. Her goal is to provide students with early exposure to various interests, which she believes is highly beneficial.",
