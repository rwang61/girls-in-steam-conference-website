...
test('renders Our Values section', () => {
    ...
    const communityInfo = screen.getByText('Building vertical network & horizontal community amongst our program attendees.');
    ...
    const educationInfo = screen.getByText('Connecting our program attendees with role models and exposing them to new knowledge.');
